...
class Biblioteca: # Esta es la clase bibliotecas, cuyos métodos permiten gestionarla
    ...
    def agrega_libro(self, *campos):
        ...
        # Añadimos lo recibido a un diccionario con los campos que hemos definido como clave
        libro = {}
        for i, campo in enumerate(self.campos):
            libro[campo] = campos[i]
        
        self.libros.append(libro) # Añadimos el libro a la colección
